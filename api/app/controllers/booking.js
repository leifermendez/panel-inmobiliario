...
exports.getItems = async (req, res) => {
  try {
    ...
    const data = db.getLookBookings(model, query, req.user)
...
exports.getItem = async (req, res) => {
  try {
    ...
    const data = db.getLookBookingSingle(model, {_id: mongoose.Types.ObjectId(id)})
...
exports.createItem = async (req, res) => {
  try {
    ...
    const data = await db.createItem(req, model, db.getLookBookingSingle);
    await eventService.setEvent(data, req, 'booking')
